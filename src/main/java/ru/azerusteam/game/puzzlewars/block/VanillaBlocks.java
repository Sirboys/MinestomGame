...
public enum VanillaBlocks {
    ACACIA_WALL_SIGN(() -> new SignBlock(Block.ACACIA_WALL_SIGN)),
    ACACIA_SIGN(() -> new SignBlock(Block.ACACIA_SIGN)),
    OAK_WALL_SIGN(() -> new SignBlock(Block.OAK_WALL_SIGN)),
    OAK_SIGN(() -> new SignBlock(Block.OAK_SIGN)),
    BIRCH_WALL_SIGN(() -> new SignBlock(Block.BIRCH_WALL_SIGN)),
    BIRCH_SIGN(() -> new SignBlock(Block.BIRCH_SIGN)),
    SPRUCE_WALL_SIGN(() -> new SignBlock(Block.SPRUCE_WALL_SIGN)),
    SPRUCE_SIGN(() -> new SignBlock(Block.SPRUCE_SIGN)),
    DARK_OAK_WALL_SIGN(() -> new SignBlock(Block.DARK_OAK_WALL_SIGN)),
    DARK_OAK_SIGN(() -> new SignBlock(Block.DARK_OAK_SIGN)),
    JUNGLE_WALL_SIGN(() -> new SignBlock(Block.JUNGLE_WALL_SIGN)),
    JUNGLE_SIGN(() -> new SignBlock(Block.JUNGLE_SIGN)),
